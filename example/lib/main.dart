...
class DialPadMainScreen extends StatefulWidget {
  const DialPadMainScreen({Key? key}) : super(key: key);
...
class _DialPadMainScreenState extends State<DialPadMainScreen> with TickerProviderStateMixin {
  ...
  Future<void> _checkServiceStatus() async {
    try {
      ...
      if (mounted && isRunning != _isServiceRunning) {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    _isServiceRunning ? 'Online' : 'Offline',
    ...
    return Expanded(
      child: Padding(
        ...
        child: Material(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(40),
            splashColor: const Color(0xFF00C853).withOpacity(0.3),

# HATIF - VoIP Calling Application

HATIF is a professional VoIP calling application powered by the Linphone Flutter Plugin. This application provides enterprise-grade calling features using the Linphone SDK's native Android functionalities integrated with Flutter.

## About HATIF

HATIF (هاتف) is a modern VoIP communication solution that enables real-time voice calling over UDP protocol with professional call management features.

## Getting Started

This application demonstrates the full implementation of Linphone Flutter Plugin capabilities.
